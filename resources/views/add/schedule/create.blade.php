    ...
    <div class="my_container">
        <div class="container">
           ...
           <center>
            ...
            {{--Форма добавления--}}
            <form method="post" action="{{ route('add.schedule') }}" class=" mt-2 bg-info">
                @csrf
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body bg-info">
                            ...
                            <form method="post" action="{{ route('add.schedule.outRent') }}" >
                                @csrf
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body bg-info">
                    ...
                    <form method="post" action="{{ route('add.schedule.outS') }}" >
                        @csrf
